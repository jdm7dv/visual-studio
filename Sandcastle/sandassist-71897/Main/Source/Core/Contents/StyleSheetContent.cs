...
namespace Sandcastle.Contents
{
    ...
    public sealed class StyleSheetContent : BuildContent<StyleSheetItem, StyleSheetContent>
    {
        ...
        public const string TagName = "styleSheetContent";
        ...
        /// <para>
        /// For the <see cref="StyleSheetContent"/> class instance, this 
        /// property is <see cref="StyleSheetContent.TagName"/>.
        /// </para>
        /// </value>
        ...
        public override void ReadXml(XmlReader reader)
        {
            ...
            while (reader.Read())
            {
                if (reader.NodeType == XmlNodeType.Element)
                {
                    if (String.Equals(reader.Name, StyleSheetItem.TagName,
                        StringComparison.OrdinalIgnoreCase))
                    {
                        StyleSheetItem item = new StyleSheetItem();
                        item.Content = this;
                        item.ReadXml(reader);
