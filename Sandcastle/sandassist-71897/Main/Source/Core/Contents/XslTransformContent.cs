...
namespace Sandcastle.Contents
{
    ...
    public sealed class XslTransformContent : BuildContent<XslTransformItem, XslTransformContent>
    {
        ...
        public const string TagName = "xslTransformContent";
        ...
        /// <para>
        /// For the <see cref="XslTransformContent"/> class instance, this 
        /// property is <see cref="XslTransformContent.TagName"/>.
        /// </para>
        /// </value>
        ...
        public override void ReadXml(XmlReader reader)
        {
            ...
            while (reader.Read())
            {
                if (reader.NodeType == XmlNodeType.Element)
                {
                    if (String.Equals(reader.Name, XslTransformItem.TagName,
                        StringComparison.OrdinalIgnoreCase))
                    {
                        XslTransformItem item = new XslTransformItem();
                        item.Content = this;
                        item.ReadXml(reader);
