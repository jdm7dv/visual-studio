...
namespace Sandcastle.Contents
{
    ...
    public sealed class RuleContent : BuildContent<RuleItem, RuleContent>
    {
        ...
        public const string TagName = "ruleContent";
        ...
        /// <para>
        /// For the <see cref="RuleContent"/> class instance, this property is 
        /// <see cref="RuleContent.TagName"/>.
        /// </para>
        /// </value>
        ...
        public override void ReadXml(XmlReader reader)
        {
            ...
            while (reader.Read())
            {
                if (reader.NodeType == XmlNodeType.Element)
                {
                    if (String.Equals(reader.Name, RuleItem.TagName,
                        StringComparison.OrdinalIgnoreCase))
                    {
