...
{
    [Serializable]
    public sealed class VcProjectDeploymentToolElement : VcProjectElement
    {
        #region Public Fields

        public const string TagName = "DeploymentTool";
        ...
        internal VcProjectDeploymentToolElement()
            : this(null, null)
        {
        }
        ...
        public override VcProjectElementType ElementType
        {
            get
            {
                return VcProjectElementType.DeploymentTool;
            }
        }
