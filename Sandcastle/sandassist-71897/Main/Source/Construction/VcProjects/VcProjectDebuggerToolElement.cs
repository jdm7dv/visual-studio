...
{
    [Serializable]
    public sealed class VcProjectDebuggerToolElement : VcProjectElement
    {
        #region Public Fields

        public const string TagName = "DebuggerTool";
        ...
        internal VcProjectDebuggerToolElement()
            : this(null, null)
        {
        }

        internal VcProjectDebuggerToolElement(VcProjectContainerElement parent,
        ...
        public override VcProjectElementType ElementType
        {
            get
            {
                return VcProjectElementType.DebuggerTool;
            }
        }
