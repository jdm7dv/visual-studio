...
namespace Sandcastle.Construction.Utils
{
	...
	/// </summary>
    public sealed class EolToken : Token
	{
	...
	{
		/// <summary>Default constructor.</summary>
		protected StringToken(string s) : base(0) { obj = s; }
	...
	/// characters.
	/// </summary>
    public sealed class WordToken : StringToken 
	{ 
	...
	/// </summary>
    public sealed class QuoteToken : StringToken 
	{ 
		/// <summary>Constructor with the specified value.</summary>
	...
	/// comments.
	/// </summary>
    public sealed class CommentToken : StringToken 
	{ 
		/// <summary>Constructor with the specified value.</summary>
	...
	/// </summary>
    public sealed class WhitespaceToken : StringToken 
	{ 
		/// <summary>Constructor with the specified value.</summary>
	...
	/// </summary>
    public sealed class CharToken : Token
	{
		/// <summary>Constructor with the specified value
		/// and line number.</summary>
	...
	/// </summary>
    public sealed class FloatToken : Token
	{
		/// <summary>Constructor with the specified value.</summary>
