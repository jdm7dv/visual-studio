...
{
    [Serializable]
    public sealed class ReferenceCloneConfiguration : ReferenceComponentConfiguration
    {
        ...
        public const string ConfigurationName =
            "Sandcastle.References.ReferenceCloneConfiguration";
        ...
        /// <overloads>
        /// Initializes a new instance of the <see cref="ReferenceCloneConfiguration"/> class.
        /// </overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceCloneConfiguration"/> class
        /// to the default values.
        /// </summary>
        public ReferenceCloneConfiguration()
        {
        }
        ...
        /// <see cref="ReferenceCloneConfiguration"/> class, a copy constructor.
        /// </summary>
        /// <param name="source">
        /// An instance of the <see cref="ReferenceCloneConfiguration"/> class from which the
        /// initialization parameters or values will be copied.
        /// </param>
        /// <exception cref="ArgumentNullException">
        /// If the parameter <paramref name="source"/> is <see langword="null"/>.
        /// </exception>
        public ReferenceCloneConfiguration(ReferenceCloneConfiguration source)
            : base(source)
        {
        }
        ...
        /// </para>
        /// <para>
        /// The value is <see cref="ReferenceCloneConfiguration.ConfigurationName"/>
        /// </para>
        /// </value>
        public override string Name
        {
            get
            {
                return ReferenceCloneConfiguration.ConfigurationName;
            }
        }
        ...
        {
            ReferenceCloneConfiguration options = new ReferenceCloneConfiguration(this);
