...
// This is an updated version of the add-in with fixes for issue reported 
// in the work item: http://sandcastle.codeplex.com/workitem/8852
...
namespace Sandcastle.Reflections
{
    ...
    using Parameter = System.Compiler.Parameter;

    public sealed class ExtensionMethodAddIn : MRefBuilderAddIn
    {                                                  
        private Dictionary<TypeNode, List<Method>> index = 
            new Dictionary<TypeNode, List<Method>>();
