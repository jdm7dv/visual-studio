...
{                   
    ...
    {               
        private List<IEnumerable<BuildComponent>> branches = 
            new List<IEnumerable<BuildComponent>>();
        ...
        {           
            ...
            {
                IList<BuildComponent> branch = 
                    BuildAssembler.LoadComponents(branch_node);
                branches.Add(branch);
            } 
        }
