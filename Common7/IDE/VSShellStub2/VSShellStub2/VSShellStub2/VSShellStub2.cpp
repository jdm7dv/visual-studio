// VSShellStub2.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "VSShellStub2.h"
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	nRetVal = StartWithCommandLine(lpwCmdLine, L"VSShellStub2", nCmdShow, NULL, NULL);
