...
NamespaceName:	Identifier ( Period IdentifierOrKeyword )*;
...
PropertyModifier:	AutoPropertyModifier | 'Default' | 'ReadOnly' | 'WriteOnly';
...
QualifiedOpenTypeName:	Identifier TypeArityList? | 'Global' Period IdentifierOrKeyword TypeArityList? | QualifiedOpenTypeName Period IdentifierOrKeyword TypeArityList?;
TypeArityList:	OpenParenthesis 'Of' CommaList? CloseParenthesis;
CommaList:	Comma Comma*;
NullableOpenTypeName:	QualifiedOpenTypeName '?';
...
SingleLineLambda:	'Function' ( OpenParenthesis ParameterList? CloseParenthesis )? Expression
	| 'Sub' ( OpenParenthesis ParameterList? CloseParenthesis )? Statement;
MultiLineLambda:	MultiLineFunctionLambda | MultiLineSubLambda;
MultiLineFunctionLambda:	'Function' ( OpenParenthesis ParameterList? CloseParenthesis )? ( 'As' TypeName )? LineTerminator
	Block
	'End' 'Function';
MultiLineSubLambda:	'Sub' ( OpenParenthesis ParameterList? CloseParenthesis )? LineTerminator
	Block
	'End' 'Sub';
