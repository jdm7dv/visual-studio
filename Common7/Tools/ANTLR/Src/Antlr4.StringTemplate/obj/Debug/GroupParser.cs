...
// $ANTLR 3.5.0.1 Compiler\\Group.g3 2013-06-14 09:39:37
...
public partial class GroupParser : Antlr.Runtime.Parser
{
	...
	{
		public static readonly BitSet _oldStyleHeader_in_group99 = new BitSet(new ulong[]{0x11000400UL});
		public static readonly BitSet _delimiters_in_group104 = new BitSet(new ulong[]{0x11000400UL});
		public static readonly BitSet _28_in_group111 = new BitSet(new ulong[]{0x4000UL});
		public static readonly BitSet _STRING_in_group113 = new BitSet(new ulong[]{0x11000400UL});
		public static readonly BitSet _28_in_group121 = new BitSet(new ulong[]{0x400UL});
		public static readonly BitSet _ID_in_group132 = new BitSet(new ulong[]{0x11080400UL});
		public static readonly BitSet _19_in_group135 = new BitSet(new ulong[]{0x400UL});
		public static readonly BitSet _ID_in_group137 = new BitSet(new ulong[]{0x11080400UL});
